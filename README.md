...
*   **Árbol Temático Interactivo**: Carga recursivamente la estructura de categorías de la CEPAL.
...
*   `app.js`: Lógica de consumo de API de la CEPAL, generación de gráficos con Chart.js y motores de diagnóstico locales.
...
*   [cepal_indicator_mapping.md](cepal_indicator_mapping.md)
